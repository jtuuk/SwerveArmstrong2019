...
AddOutputFilter chunkFilter
		...
		<Item Name="Team Code" Type="Folder">
			<Item Name="CameraServo" Type="Folder">
				<Item Name="CameraServo.vi" Type="VI" URL="../CameraServo.vi"/>
				<Item Name="CameraServoPWM.vi" Type="VI" URL="../CameraServoPWM.vi"/>
			...
			<Item Name="Elevator" Type="Folder">
				...
				<Item Name="ElevatorBase_SLND.vi" Type="VI" URL="../ElevatorBase_SLND.vi"/>
				<Item Name="ElevBaseModeToDash.vi" Type="VI" URL="../ElevBaseModeToDash.vi"/>
				<Item Name="ElevEncActions.vi" Type="VI" URL="../ElevEncActions.vi"/>
				<Item Name="ElevLimit.vi" Type="VI" URL="../ElevLimit.vi"/>
			</Item>
			<Item Name="Hatch" Type="Folder">
				<Item Name="HatchLatch_SLND.vi" Type="VI" URL="../HatchLatch_SLND.vi"/>
				<Item Name="HatchLatchToDash.vi" Type="VI" URL="../HatchLatchToDash.vi"/>
				<Item Name="HatchLimitGet.vi" Type="VI" URL="../HatchLimitGet.vi"/>
				<Item Name="HatchModeToDash.vi" Type="VI" URL="../HatchModeToDash.vi"/>
			</Item>
			<Item Name="Lift" Type="Folder">
				<Item Name="Lift.vi" Type="VI" URL="../Lift.vi"/>
				<Item Name="LiftLimit.vi" Type="VI" URL="../LiftLimit.vi"/>
			</Item>
			<Item Name="Misc" Type="Folder">
				<Item Name="Deadband.vi" Type="VI" URL="../Deadband.vi"/>
				<Item Name="Debounce.vi" Type="VI" URL="../Debounce.vi"/>
				<Item Name="EnumToString.vi" Type="VI" URL="../EnumToString.vi"/>
			...
			<Item Name="Swerve" Type="Folder">
				...
				<Item Name="SwerveHomeStore.vi" Type="VI" URL="../SwerveHomeStore.vi"/>
				<Item Name="SwerveMapping.vi" Type="VI" URL="../SwerveMapping.vi"/>
				<Item Name="SwerveMath.vi" Type="VI" URL="../SwerveMath.vi"/>
				<Item Name="SwerveModeToDash.vi" Type="VI" URL="../SwerveModeToDash.vi"/>
			...
			<Item Name="Torros" Type="Folder">
				<Item Name="Torros.vi" Type="VI" URL="../Torros.vi"/>
				<Item Name="Torros_Slnd.vi" Type="VI" URL="../Torros_Slnd.vi"/>
				<Item Name="TorrosDown.vi" Type="VI" URL="../TorrosDown.vi"/>
				<Item Name="TorrosUp.vi" Type="VI" URL="../TorrosUp.vi"/>
			</Item>
			<Item Name="TypeDefs" Type="Folder">
				<Item Name="ElevBasePos.ctl" Type="VI" URL="../ElevBasePos.ctl"/>
		...
		<Item Name="ElevModes.ctl" Type="VI" URL="../ElevModes.ctl"/>
